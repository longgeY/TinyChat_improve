        ...
        for (int col = mat_args->start; col < mat_args->end; col += 4) {
            ...
            for (int ch = 0; ch < k;) {
                ...
                for (int qj = 0; qj < 16; qj++) {
                    ...
                    signed char w_de_1 = (packed_int4_1 & 0x0F) - 8;
                    signed char w_de_2 = (packed_int4_2 & 0x0F) - 8;
                    signed char w_de_3 = (packed_int4_3 & 0x0F) - 8;
                    signed char w_de_160 = (packed_int4_0 >> 4) - 8;
                    signed char w_de_161 = (packed_int4_1 >> 4) - 8;
                    signed char w_de_162 = (packed_int4_2 >> 4) - 8;
                    signed char w_de_163 = (packed_int4_3 >> 4) - 8;
...
void MatmulOperator::mat_mul_multithreading_loop_unrolling(struct matmul_params *params) {
    ...
    for (int i = 0; i < num_thread; ++i) {
        ...
        int rc = pthread_create(&thread_pool[i], NULL, multithreading_loop_unrolling_worker_func, (void *)&threads_args[i]);
        if (rc) {
